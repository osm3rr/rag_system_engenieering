...
class DecisionSupervisor(BaseModel):
    siguiente_agente: Literal["agente_documento_01", "agente_documento_02", "finalizar"] = Field(
        ...
        "recepcionista amable y preguntale si quiere tener infomación sobre proyectos (documento_01) o procedimientos (documento_02). Si consideras que el usuario ya" \
